# CHEZ Ambroise - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **CHEZ Ambroise**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@chezambroise.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@chezambroise.cm` | `user123` | |
...
*   **Contact :** contact@chezambroise.cm